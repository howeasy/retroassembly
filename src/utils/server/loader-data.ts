...
export function getCommonLoaderData<T>(data: T = {} as T) {
  ...
  const env = {
    RETROASSEMBLY_RUN_TIME_BASE_URL: runTimeEnv.RETROASSEMBLY_RUN_TIME_BASE_URL,
    RETROASSEMBLY_RUN_TIME_ENABLE_SHARED_ROM_LIBRARY: runTimeEnv.RETROASSEMBLY_RUN_TIME_ENABLE_SHARED_ROM_LIBRARY,
    ...
    RETROASSEMBLY_RUN_TIME_SHARED_LIBRARY_ONLY: runTimeEnv.RETROASSEMBLY_RUN_TIME_SHARED_LIBRARY_ONLY,
  }
